console.log("DOM Extractor content script 실행됨");
...
let filteredDomData = filterVisibleElements(domData) || domData;
chrome.storage.local.set({ filteredDomData }, () => {
    console.log("DOM 데이터 저장 완료:");
});
